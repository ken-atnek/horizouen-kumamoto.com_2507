...
const DetailForm = () => {
  ...
  const handleListItemChange = (value: string) => {
    if (listItems.includes(value)) {
      setListItems(listItems.filter((item) => item !== value));
    } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append('nameKana', NameKana);
    ...
    formData.append('listItem', listItems.join(','));
    if (imageFile) {
      formData.append('image', imageFile);
    }
    try {
      const response = await fetch(
        'https://demo-horizouen-kumamoto.tuna-pic.co.jp/backend/contact.php',
        {
          method: 'POST',
          body: formData,
        }
            ...
            {isConfirming ? (
              ...
              <div className={styles.statusConfirm}>
                ...
                {/* <dl>
                  <dt>画像</dt>
                  <dd>
                    <div>{imageFile ? imageFile.name : 'なし'}</div>
                  </dd>
                </dl> */}
                <dl>
                  <dt>お問い合わせ（選択式）</dt>
                  <dd>
                    <div>{listItems.join('、')}</div>
                  </dd>
                </dl>
              ...
              <div className={styles.blockFormInner}>
                ...
                {/* <dl className={styles.formUpImage}>
                  <dt>画像アップロード</dt>
                  <dd>
                    <input
                      type="file"
                    ...
                    />
                    <p className={styles.notice}>（最大2MB）</p>
                  </dd>
                </dl> */}
                  ...
                  <dd>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="庭木の剪定"
                        checked={listItems.includes('庭木の剪定')}
                        onChange={() => handleListItemChange('庭木の剪定')}
                      />
                      <span>庭木の剪定</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="草刈り"
                        checked={listItems.includes('草刈り')}
                        onChange={() => handleListItemChange('草刈り')}
                      />
                      <span>草刈り</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="伐採・伐根"
                        checked={listItems.includes('伐採・伐根')}
                        onChange={() => handleListItemChange('伐採・伐根')}
                      />
                      <span>伐採・伐根</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="防草シート施工"
                        checked={listItems.includes('防草シート施工')}
                        onChange={() => handleListItemChange('防草シート施工')}
                      />
                      <span>防草シート施工</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="植栽・販売"
                        checked={listItems.includes('植栽・販売')}
                        onChange={() => handleListItemChange('植栽・販売')}
                      />
                      <span>植栽・販売</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="お庭の年間管理"
                        checked={listItems.includes('お庭の年間管理')}
                        onChange={() => handleListItemChange('お庭の年間管理')}
                      />
                      <span>お庭の年間管理</span>
                    </label>
                    <label>
                      <input
                        ...
                        name="listItem[]"
                        value="その他"
                        checked={listItems.includes('その他')}
                        onChange={() => handleListItemChange('その他')}
                      />
                      <span>その他</span>
                    </label>
                  </dd>
